class Character extends EventDispatcher {
    constructor(sheet, width, height, mapX, mapY, speed) {
        super();
        ...
        this.animation = [];    // The order of animation.
    ...
    getAttribute(mapX, mapY, fit = false) {
        const e = new Event({ mapX: mapX, mapY: mapY, fit: fit })
        this.dispatchEvent('getAttr', e);
    }

    render(canvas) {
        this.x = this.mapX * this._width  + this.fieldOriginX;
        this.y = this.mapY * this._height + this.fieldOriginY;
...
class Player extends Character {
    constructor(sheet, width, height, mapX, mapY, speed = NORMAL) {
        super(sheet, width, height, mapX, mapY, speed);
