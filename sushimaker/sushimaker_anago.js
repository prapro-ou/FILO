(function makeAnago() {        
    ...
    const blockImages = [];
    const imagePaths = [
    '../sushi_img/anago_sashimi1.png',
    '../sushi_img/anago_sashimi2.png',
    '../sushi_img/anago_sashimi3.png',
    '../sushi_img/anago_sashimi4.png'
    ];
    ...
    function showImage() {
        ...
        // シャリにネタが乗ったとき
        if (Good == 1){
            img.src = '../sushi_img/sushi_nigiri_anago.png'; // 表示する画像のパス
