(function makeTorosalmon() {
   ...
   //キャンバスサイズ
    ...
    const blockImages = [];
    const imagePaths = [
    '../sushi_img/torosalmon_sashimi1.png',
    '../sushi_img/torosalmon_sashimi2.png',
    '../sushi_img/torosalmon_sashimi3.png',
    '../sushi_img/torosalmon_sashimi4.png'
    ];
    ...
    function showImage() {
        ...
        // シャリにネタが乗ったとき
        if (Good == 1){
            img.src = '../sushi_img/sushi_nigiri_torosalmon.png'; // 表示する画像のパス
