    (function() {    
        ...
        const blockImages = [];
        const imagePaths = [
        '../sushi_img/ebi_sashimi1.png',
        '../sushi_img/ebi_sashimi2.png',
        '../sushi_img/ebi_sashimi3.png',
        '../sushi_img/ebi_sashimi4.png'
        ];
        ...
        function showImage() {
            ...
            // シャリにネタが乗ったとき
            if (Good == 1){
                img.src = '../sushi_img/sushi_nigiri_mushiebi.png'; // 表示する画像のパス
